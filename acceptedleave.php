                    ...
                    <li class="profile"><button onclick="myFunction()" class="dropbtn togle">profile</button>
                        <div id="myDropdown" class="dropdown-content">
                            ...
                            ?>
                                ...
                                <a href="acceptedleave.php?logout='1'" style="color:red;"><i class="glyphicon glyphicon-off"></i> logout</a>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        ...
                        <a href="leave.php" class="btn btn-info pull-right"">apply leave</a>
                    </div>
                    <table class=" table table-dark table-hover">
                            ...
                            $records = mysqli_query($db, "SELECT * FROM leaveaccepted WHERE username= '" . $_SESSION["username"] . "'"); // fetch data from database
