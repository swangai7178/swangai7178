                    ...
                    <li class="profile"><button onclick="myFunction()" class="dropbtn togle">profile</button>
                        <div id="myDropdown" class="dropdown-content">
                            ...
                            ?>
                                ...
                                <a href="teachers.php?logout='1'" style="color:red;"><i class="glyphicon glyphicon-off"></i> logout</a>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        ...
                        <a href="newteacher_tally.php" class="btn btn-info pull-right">Add New teacher tally</a>
                    </div>
                    <table class="table table-dark table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="editteacher.php?id=<?php echo $data['id']; ?>">Edit</a></td>
