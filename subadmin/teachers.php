            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        ...
                        <button class="btn btn-info pull-right">add new teacher</button>
                    </div>
                    <div class="panel-body">
                        ...
                        <table class="table table-dark table-hover">
                            ...
                            <?php 
$s="select * from userregister,teachers where userregister.username=teachers.username and userregister.county='" . $_SESSION["username"] . "'";
