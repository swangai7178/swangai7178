                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <table class=" table table-dark table-hover">
                            ...
                            $records = mysqli_query($db, "SELECT * FROM additional WHERE username= '" . $_SESSION["username"] . "'"); // fetch data from database

                            while ($data = mysqli_fetch_array($records)) {
                            ?>
                                    <tr>
                                        <td>
                                            <div class="col" id="user_data_1"><?php echo $data['subcounty']; ?></div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_2"><?php echo $data['zone']; ?> </div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_3"><?php echo $data['kneccode']; ?> </div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_3"><?php echo $data['nemiscode']; ?> </div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_3"><?php echo $data['noclass']; ?> </div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_3"><?php echo $data['size']; ?> </div>
                                        </td>
                                        <td>
                                            <div class="col" id="user_data_3"><?php echo $data['state']; ?> </div>
                                        </td>
                                    </tr>
                                <?php
                                }
